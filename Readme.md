...
Nest is a framework for building efficient and scalable <a href="https://nodejs.org" target="_blank">Node.js</a> server-side applications. It uses modern JavaScript, is built with <a href="https://www.typescriptlang.org" target="_blank">TypeScript</a> (while remaining compatible with pure JavaScript), and combines elements of OOP (Object-Oriented Programming), FP (Functional Programming), and FRP (Functional Reactive Programming).

<p>Under the hood, Nest uses <a href="https://expressjs.com/" target="_blank">Express</a>, but it also provides compatibility with a wide range of other libraries, like <a href="https://github.com/fastify/fastify" target="_blank">Fastify</a>, enabling easy use of the many third-party plugins available.</p>

## Philosophy

In recent years, thanks to Node.js, JavaScript has become the “lingua franca” of the web for both front-end and back-end applications, giving rise to excellent projects like <a href="https://angular.io/" target="_blank">Angular</a>, <a href="https://github.com/facebook/react" target="_blank">React</a>, and <a href="https://github.com/vuejs/vue" target="_blank">Vue</a>, which improve developer productivity and enable the construction of fast, testable, and extensible frontend applications.  

However, on the server side, while there are many superb libraries, helpers, and tools for Node.js, none of them effectively address the main problem: architecture.  

Nest aims to provide an application architecture out of the box, allowing effortless creation of highly testable, scalable, loosely coupled, and easily maintainable applications. Its architecture is heavily inspired by Angular.
...
For questions and support, please use the official [Discord channel](https://discord.gg/G7Qnnhy). The issue list of this repository is **exclusively** for bug reports and feature requests.

## Issues

Please read the [Issue Reporting Checklist](https://github.com/nestjs/nest/blob/master/CONTRIBUTING.md#-submitting-an-issue) before opening an issue. Issues not conforming to the guidelines may be closed immediately.

## Consulting

With official support, you can get expert help directly from the Nest core team. We provide dedicated technical support, migration strategies, best practice advice, PR reviews, and team augmentation. Read more about [support here](https://enterprise.nestjs.com).

## Support

Nest is an MIT-licensed open-source project. It can grow thanks to sponsors and amazing backers. If you'd like to join them, please [read more here](https://docs.nestjs.com/support).
...
<td><a href="https://mojam.co" target="_blank"><img src="https://nestjs.com/img/logos/mojam-logo.svg" width="80" valign="middle" /></a></td>
...
<td><a href="https://intrinsic.ventures/" target="_blank"><img src="https://nestjs.com/img/logos/intrinisic-logo.svg" width="210" valign="middle" /></a></td>
